  ...
  categories: [
    ...
    },
    {
      ...
      },
      {
        ...
        description: 'AAA used a combination of Adobe Omniture and Google Analytics for tracking. I was tasked with helping the business analysts maintain and implement tracking for the Sitecore Experience platform in order to track customer behavior and interactions. Part of this role required me to manage Google Tag Manager GTM for different applications. '
      },
      {
        url: '',
        title: 'Sitecore C# .NET Development',
        description: 'As a Sitecore Developer, the main tool I use on a regular basis is C# .NET. For the past 10 years I have been working with C# and have experience with a number of different projects. As a developer I love to solve problems and learn new techniques and patterns for coding.'
      },
      {
        url: '',
